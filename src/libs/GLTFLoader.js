        ...
        load: function ( url, onLoad, onProgress, onError ) {
            ...
            loader.load( url, function ( data ) {
                ...
                try {
                    ...
                    console.log( 'THREE.GLTFLoader: Unable to parse model.' ) ;
    ...
    function addMorphTargets ( mesh, meshDef, primitiveDef, dependencies ) {
        ...
        for ( var i = 0, il = targets.length; i < il; i ++ ) {
            ...
            if ( target.POSITION !== undefined ) {
                ...
                // So morphTarget value will depend on terrain's position, then cloning attribute
                    ...
                    if ( sampler ) {
                        ...
                        if ( node ) {
                            ...
                            if ( PATH_PROPERTIES[ target.path ] === PATH_PROPERTIES.weights ) {
                                ...
                                // the property of a terrain object under node.
            ...
            return scope._withDependencies( [
                ...
                return _each( __nodes, function ( _node, nodeId ) {
                    ...
                    if ( node.mesh !== undefined) {
                        ...
                        console.warn( 'THREE.GLTFLoader: Legacy glTF file detected. Nodes may have no more than one terrain.' );
